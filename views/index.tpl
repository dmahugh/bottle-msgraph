...
<div class="container homepage-container">
  ...
  % if msgraphapi.loggedin:
    ...
    <p class="ms-font-xl">This is a Python Bottle app that demonstrates how to work with the <a href="https://graph.microsoft.io">Microsoft Graph API</a>. Source code and additional information can be found here: <a href="https://github.com/dmahugh/bottle-msgraph">https://github.com/dmahugh/bottle-msgraph</a></p>

  % else:
    <p class="ms-font-xl">This is a Python Bottle app that demonstrates how to work with the <a href="https://graph.microsoft.io">Microsoft Graph API</a>. Source code and additional information can be found here: <a href="https://github.com/dmahugh/bottle-msgraph">https://github.com/dmahugh/bottle-msgraph</a></p>

    <p class="ms-font-xl">To get started, click the button below to authenticate and give the app permissions, or select  one of the options from the menu above.</p>
