...
% if msgraphapi.loggedin:
  ...
  <tr><th>Access token:</th><td>{{ msgraphapi.token_abbrev(token_type='access') }}</td></tr>
  <tr><th>Refresh token:</th><td>{{ msgraphapi.token_abbrev(token_type='refresh') }}</td></tr>
  ...
  <button type="button" class="btn btn-primary btn-md btn-about" onclick="window.location.href='/logout?redirect=/about'">Disconnect</button>
  <button type="button" class="btn btn-primary btn-md btn-about" onclick="window.location.href='/refresh_token?redirect_to=/about'">Refresh Token</button>
  <button type="button" class="btn btn-primary btn-md btn-about" onclick="window.location.href='/clearcache?redirect=/about'">Clear Cache</button>
